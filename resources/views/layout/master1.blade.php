  ...
  <div class="wrapper light-theme">
    ...
    <div class="fixed-sidebar-left">
      <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li> <a class="active-page" href="{{ route('dashboard') }}">
        ...
        <li> <a href="{{ route('makedeposit') }}">
            <div class="pull-left"><i class="mdi mdi-cart-plus mr-20"></i><span class="right-nav-text">Make Deposit</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="{{ route('withdrawal') }}">
            <div class="pull-left"><i class="mdi mdi-cloud-upload mr-20"></i><span class="right-nav-text">Withdraw Fund</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="{{ route('deposithistory') }}">
            <div class="pull-left"><i class="mdi mdi-code-greater-than-or-equal mr-20"></i><span class="right-nav-text">Deposit History</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="{{ route('withdrawalhistory') }}">
            <div class="pull-left"><i class="mdi mdi-cloud-circle mr-20"></i><span class="right-nav-text">Withdraw History</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="#">
            <div class="pull-left"><i class="mdi mdi-account-multiple-plus mr-20"></i><span class="right-nav-text">Referral</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="#">
            <div class="pull-left"><i class="mdi mdi-link-variant mr-20"></i><span class="right-nav-text">Referral Link</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="#">
            <div class="pull-left"><i class="mdi mdi-account-settings-variant mr-20"></i><span class="right-nav-text">Account Setting</span></div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li> <a href="#">
