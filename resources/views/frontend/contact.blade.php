      ...
      <div class="container">
        <div class="row pt-30">
          ...
          <div class="col-md-8">
            ...
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="http://thememascot.net/demo/personal/s/cryptopress/v3.0/demo/includes/sendmail.php" method="post">
